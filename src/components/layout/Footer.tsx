      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex items-center gap-6">
            ...
            <Link href="/" className="flex items-center gap-2">
              ...
              <span className="text-sm text-gray-500">
                trusted local experts, in your language
              </span>
            </Link>
          </div>
          ...
          <div className="flex items-center gap-4">
            <span className="text-sm text-gray-500">
              © {currentYear} Localisio. All rights reserved.
            </span>
            ...
            <div className="flex items-center gap-2">
              ...
              <a href="#" className="w-8 h-8 bg-blue-400 rounded flex items-center justify-center text-white hover:bg-blue-500 transition-colors">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
