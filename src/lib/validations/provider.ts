...
export const updateProviderProfileSchema = z.object({
  ...
  languages: z.array(z.string()).max(10, 'Too many languages').optional(),
  services: z.array(z.enum(serviceCodes as [string, ...string[]])).max(5, 'Too many services').optional(),
  youtube_url: z.string().url('Invalid URL').nullable().optional(),
});
