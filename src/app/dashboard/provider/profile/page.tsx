...
function FloatingSaveBar({
  ...
  useEffect(() => {
    const handleScroll = () => {
      // Show floating bar when scrolled past 300px
      ...
      <div className="bg-white/95 backdrop-blur-sm border-t border-slate-200 shadow-lg">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
          ...
          {(success || error || warning) && (
            <div className="mb-3">
              {error && (
                <div className="p-3 rounded-lg bg-red-50 text-red-700 border border-red-200 flex items-center justify-between text-sm">
                  <span>{error}</span>
                  <button onClick={onDismissError} className="ml-2 text-red-500 hover:text-red-700">
              ...
              {warning && (
                <div className="p-3 rounded-lg bg-amber-50 text-amber-700 border border-amber-200 flex items-center justify-between text-sm">
                  ...
                  <button onClick={onDismissWarning} className="ml-2 text-amber-500 hover:text-amber-700 flex-shrink-0">
                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clipRule="evenodd" />
                    </svg>
                  </button>
              ...
              {success && !warning && !error && (
                <div className="p-3 rounded-lg bg-green-50 text-green-700 border border-green-200 flex items-center gap-2 text-sm">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <form onSubmit={handleSubmit}>
        ...
        {/* Bottom actions (visible when at the bottom of the page) */}
        ...
        {/* Floating save bar (visible when scrolling) */}
        <FloatingSaveBar
          isSaving={isSaving}
          success={success}
          error={error}
